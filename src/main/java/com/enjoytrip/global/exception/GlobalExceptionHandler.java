...
=======
    ...
    public ResponseEntity<?> methodArgumentHandlingException(MethodArgumentNotValidException e) throws IOException {
        return JsonResponse.fail("입력값 에러", HttpStatus.BAD_REQUEST.value());
    }
